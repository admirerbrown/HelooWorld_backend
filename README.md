...
```sh
 git clone https://github.com/admirerbrown/HelooWorld_backend.git
```

- Navigate into the cloned folder

```sh
 cd heloo_world_backend
...
Feel free to check the [issues page](https://github.com/admirerbrown/HelooWorld_backend/issues).
...
This project is [MIT](https://github.com/admirerbrown/HelooWorld_backend/blob/feature1-hellow-world/LICENSE.md) licensed.
